  ...
  dbProxy: {
    ...
    tools: [
      ...
      },
      {
        name: "Hasura",
        description:
          "Instant GraphQL APIs for existing or new Postgres databases, with dynamic row and column level access contols that can integrate with existing auth systems. Power packed with an admin UI and rails-like schema migrations.",
        url: "https://hasura.io",
